 ...
 *
 */
public class ArenisRenamer implements IAuthorRenamer {

	private static final String sUsedName = "Sergio Feo Arenis (arenis@informatik.uni-freiburg.de)";

	private static final Set<String> sKnownNames = new HashSet<String>(
			Arrays.asList(new String[] { "arenis@informatik.uni-freiburg.de","arenis" }));
