 ...
 *
 */
public class MusaRenamer implements IAuthorRenamer {

	private static final String sUsedName = "Betim Musa (musab@informatik.uni-freiburg.de)";

	private static final Set<String> sKnownNames = new HashSet<String>(
			Arrays.asList(new String[] { "musab@informatik.uni-freiburg.de","musab" }));
