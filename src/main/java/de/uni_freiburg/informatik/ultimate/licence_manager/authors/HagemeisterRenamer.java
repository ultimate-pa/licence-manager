 ...
 *
 */
public class HagemeisterRenamer implements IAuthorRenamer {

	private static final String sUsedName = "Björn Hagemeister";

	private static final Set<String> sKnownNames = new HashSet<String>(
			Arrays.asList(new String[] { "hagemeib", "bjoern" }));
