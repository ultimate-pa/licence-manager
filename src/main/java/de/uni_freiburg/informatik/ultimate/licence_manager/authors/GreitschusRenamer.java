 ...
 *
 */
public class GreitschusRenamer implements IAuthorRenamer {

	private static final String sUsedName = "Marius Greitschus (greitsch@informatik.uni-freiburg.de)";

	private static final Set<String> sKnownNames = new HashSet<String>(
			Arrays.asList(new String[] { "greitsch",
					"greitsch@informatik.uni-freiburg.de", "Marius Greitschus" }));
