 ...
 *
 */
public class SchaetzleRenamer implements IAuthorRenamer {

	private static final String sUsedName = "Claus Schaetzle (schaetzc@informatik.uni-freiburg.de)";

	private static final Set<String> sKnownNames = new HashSet<String>(
			Arrays.asList(new String[] { "schaetzc@informatik.uni-freiburg.de",
					"schaetzc" }));
