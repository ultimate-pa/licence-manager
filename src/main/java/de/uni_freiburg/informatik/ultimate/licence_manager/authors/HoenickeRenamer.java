 ...
 *
 */
public class HoenickeRenamer implements IAuthorRenamer {

	private static final String sUsedName = "Jochen Hoenicke (hoenicke@informatik.uni-freiburg.de)";
	...
	public boolean shouldRename(Author author) {
		...
		return author.Name.toLowerCase().contains("hoenicke");
	}
